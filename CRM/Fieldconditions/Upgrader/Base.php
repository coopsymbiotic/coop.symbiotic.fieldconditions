 ...
 */
class CRM_Fieldconditions_Upgrader_Base {

  /**
   * @var CRM_Fieldconditions_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Fieldconditions_Upgrader(
        'coop.symbiotic.fieldconditions',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Fieldconditions_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Fieldconditions_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
